                  ...
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                        ...
                        <div class="row flex-grow">
                          <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start position-relative">
                                  <div>
                                  ...
                                  <span class="mdi mdi-crown-circle fs-4 bg-custom-warning crown-icon"></span>
                                </div>
                      ...
                      <div class="col-lg-4 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                            <div class="card bg-primary card-rounded poisiton-relative">
                              <div class="card-body pb-0">
                                <h4 class="card-title card-title-dash text-white mb-4 mt-2">
                                  Status Summary
                                </h4>
                                <span class="mdi mdi-crown-circle fs-4 bg-custom-warning" style="position: absolute; top: 1rem; right: 1rem;"></span>
                                <div class="row">
                                  <div class="col-sm-4">
                              ...
                              <div class="card-body">
                                <div class="row">
                                  ...
                                  <div class="col-lg-6 position-relative">
                                    ...
                                    <span class="mdi mdi-crown-circle fs-4 bg-custom-warning" style="position: absolute; top: -1.5rem; right: 0rem;"></span>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-lg-8 d-flex flex-column">
                        ...
                        <div class="row flex-grow position-relative">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded table-darkBGImg">
                              <div class="card-body">
                                <div class="col-sm-8">
                                  <span class="mdi mdi-crown-circle fs-4 bg-custom-warning" style="position: absolute; top: 0rem; right: 1rem;"></span>
